...
<head>
    ...
    <script>
        setInterval(() => {
            fetch("<?php echo e(url('process-queue')); ?>")
        .catch(error => console.error('Error:', error));
            }, 60000); // 60000 ms = 1 minute


            setInterval(() => {
        fetch("<?php echo e(url('leads/recurrence')); ?>")
            .catch(error => console.error('Error:', error));
            }, 6000);
    </script>
...
<?php /**PATH C:\xampp\htdocs\Portfolio\Azure-VM\erpnbs\resources\views/layouts/admin.blade.php ENDPATH**/ ?>