        ...
        <div class="row mt-2">
            <div class="col">
                <form autocomplete="off">
                    <input type="text" id="search-input" placeholder="Search settings..." class="form-control" autocomplete="off">
                </form>

                <div id="search-suggestions" class="list-group mt-2" style="display: none;"  autocomplete="off"></div>
            </div>
        </div>
        <div class="list-group list-group-flush" id="useradd-sidenav">
            <!-- General Settings -->
            <a href="#general-settings" class="list-group-item list-group-item-action border-0" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#general-settings">
                <span class="settings-ic"><i class="ti ti-settings"></i></span>
            ...
            <ul id="general-settings" class="collapse">
                <li><a href="#brand-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Brand Settings"><?php echo e(__('Brand Settings')); ?></a></li>
                <li><a href="#system-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="System Settings"><?php echo e(__('System Settings')); ?></a></li>
                <li><a href="#company-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Company Settings"><?php echo e(__('Company Settings')); ?></a></li>
                <li><a href="#currency-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Currency Settings"><?php echo e(__('Currency Settings')); ?></a></li>
            </ul>

            <!-- Security Settings -->

            <a href="#security-settings" class="list-group-item list-group-item-action border-0" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#security-settings">
                <span class="settings-ic"><i class="ti ti-lock"></i></span>
            ...
            <ul id="security-settings" class="collapse">
                <li>
                    <a href="#ip-restriction-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="IP Restriction Settings"><?php echo e(__('IP Restriction Settings')); ?></a>

                </li>
                <li>
                    <a href="#recaptcha-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="ReCaptcha Settings"><?php echo e(__('ReCaptcha Settings')); ?></a>

                </li>
            </ul>

            <!-- Customization Settings -->
            <a href="#customization-settings" class="list-group-item list-group-item-action border-0" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#customization-settings">
                <span class="settings-ic"><i class="ti ti-brush"></i></span>
                <?php echo e(__('Customization Settings')); ?>

                <div class="float-end">
                    <i class="ti ti-chevron-right"></i>
                </div>
            </a>
            <ul id="customization-settings" class="collapse">
                <li>
                    <a href="#seo-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="SEO Settings"><?php echo e(__('SEO Settings')); ?></a>

                </li>
                <li>
                    <a href="#email-notification-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Email Notification Settings"><?php echo e(__('Email Notification Settings')); ?></a>

                </li>
                <li>
                    <a href="#offer-letter-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Offer Letter Settings"><?php echo e(__('Offer Letter Settings')); ?></a>

                </li>
                <li>
                    <a href="#joining-letter-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Joining Letter Settings"><?php echo e(__('Joining Letter Settings')); ?></a>

                </li>
                <li>
                    <a href="#experience-certificate-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Experience Certificate Settings"><?php echo e(__('Experience Certificate Settings')); ?></a>

                </li>
                <li>
                    <a href="#noc-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="NOC Settings"><?php echo e(__('NOC Settings')); ?></a>

                </li>
            </ul>

            <!-- Communication Settings -->
            <a href="#communication-settings" class="list-group-item list-group-item-action border-0" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#communication-settings">
                <span class="settings-ic"><i class="ti ti-comments"></i></span>
                <?php echo e(__('Communication Settings')); ?>

                <div class="float-end">
                    <i class="ti ti-chevron-right"></i>
                </div>
            </a>
            <ul id="communication-settings" class="collapse">
                <li>
                    <a href="#email-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Email Settings"><?php echo e(__('Email Settings')); ?></a>

                </li>
                <li>
                    <a href="#pusher-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Pusher Settings"><?php echo e(__('Pusher Settings')); ?></a>

                </li>
                <li>
                    <a href="#zoom-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Zoom Settings"><?php echo e(__('Zoom Settings')); ?></a>

                </li>
                <li>
                    <a href="#slack-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Slack Settings"><?php echo e(__('Slack Settings')); ?></a>

                </li>
                <li>
                    <a href="#telegram-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Telegram Settings"><?php echo e(__('Telegram Settings')); ?></a>

                </li>
                <li>
                    <a href="#twilio-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Twilio Settings"><?php echo e(__('Twilio Settings')); ?></a>

                </li>
            </ul>

            <!-- Integration Settings -->
            <a href="#integration-settings" class="list-group-item list-group-item-action border-0" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#integration-settings">
                <span class="settings-ic"><i class="ti ti-plug"></i></span>
                <?php echo e(__('Integration Settings')); ?>

                <div class="float-end">
                    <i class="ti ti-chevron-right"></i>
                </div>
            </a>
            <ul id="integration-settings" class="collapse">
                <li>
                    <a href="#google-calendar-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Google Calendar Settings"><?php echo e(__('Google Calendar Settings')); ?></a>

                </li>
                <li>
                    <a href="#webhook-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Webhook Settings"><?php echo e(__('Webhook Settings')); ?></a>

                </li>
                <li>
                    <a href="#chat-gpt-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Chat GPT Settings"><?php echo e(__('Chat GPT Settings')); ?></a>
            ...
            <a href="#storage-cache-settings" class="list-group-item list-group-item-action border-0" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#storage-cache-settings">
                <span class="settings-ic"><i class="ti ti-hdd"></i></span>
                <?php echo e(__('Storage & Cache Settings')); ?>

                <div class="float-end">
                    <i class="ti ti-chevron-right"></i>
                </div>
            </a>
            <ul id="storage-cache-settings" class="collapse">
                <li>
                    <a href="#storage-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Storage Settings"><?php echo e(__('Storage Settings')); ?></a>

                </li>
                <li>
                    <a href="#cache-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Cache Settings"><?php echo e(__('Cache Settings')); ?></a>

                </li>
            </ul>

            <!-- Attendance Settings -->
            <a href="#attendance-settings" class="list-group-item list-group-item-action border-0" data-bs-toggle="collapse" aria-expanded="false" data-bs-target="#attendance-settings">
                <span class="settings-ic"><i class="ti ti-calendar"></i></span>
                <?php echo e(__('Attendance Settings')); ?>

                <div class="float-end">
                    <i class="ti ti-chevron-right"></i>
                </div>
            </a>
            <ul id="attendance-settings" class="collapse">
                <li>
                    <a href="#tracker-settings" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Time Tracker Settings"><?php echo e(__('Time Tracker Settings')); ?></a>

                </li>
                <li>
                    <a href="#biometric-attendance" class="list-group-item list-group-item-action border-0 ps-4" data-setting="Biometric Attendance Settings"><?php echo e(__('Biometric Attendance Settings')); ?></a>

                </li>
            </ul>

            <!-- Cookie Settings -->
            <a href="#cookie-settings" class="list-group-item list-group-item-action border-0" data-setting="Cookie Settings">
                <span class="settings-ic"><i class="ti ti-cookie"></i></span>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const items = document.querySelectorAll('.list-group-item[data-setting]');
        ...
        searchInput.addEventListener('input', function() {
            ...
            if (searchQuery) {
                items.forEach(item => {
                    const itemText = item.dataset.setting.toLowerCase();

                    // Check if the item text includes the search query
                    if (itemText.includes(searchQuery)) {
                        const suggestionItem = document.createElement('a');
                        suggestionItem.href = item.href; // link to original item
                        suggestionItem.className = 'list-group-item list-group-item-action';
                        suggestionItem.textContent = item.dataset.setting;
                ...
                suggestionsContainer.style.display = suggestionsContainer.childNodes.length > 0 ? 'block' : 'none';
            } else {
...
<script>
    document.querySelectorAll('[data-bs-toggle="collapse"]').forEach(function (element) {
        element.addEventListener('click', function () {
            ...
            const arrowIcon = this.querySelector('.float-end i');

            const target = document.querySelector(targetId);

            // Change arrow on shown and hidden events
            ...
            target.addEventListener('hidden.bs.collapse', function () {
                ...
                arrowIcon.classList.add('ti-chevron-right');
            });
        });
    });
    </script>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="float_number"
                                        class="form-label"><?php echo e(__('Float Number')); ?></label>
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                <?php echo e(Form::checkbox('twilio_customer_notification', '1', isset($settings['twilio_customer_notification']) && $settings['twilio_customer_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'customer_notification'])); ?>
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                <?php echo e(Form::checkbox('twilio_vender_notification', '1', isset($settings['twilio_vender_notification']) && $settings['twilio_vender_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'vender_notification'])); ?>
                                ...
                                <div class="col-md-4 mb-2">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span><?php echo e(__('New Invoice')); ?></span>
                                                <?php echo e(Form::checkbox('twilio_invoice_notification', '1', isset($settings['twilio_invoice_notification']) && $settings['twilio_invoice_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'invoice_notification'])); ?>
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span><?php echo e(__('New Revenue')); ?></span>
                                                <?php echo e(Form::checkbox('twilio_revenue_notification', '1', isset($settings['twilio_revenue_notification']) && $settings['twilio_revenue_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'revenue_notification'])); ?>
                                ...
                                <div class="col-md-4 mb-2">
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                <span><?php echo e(__('New Bill')); ?></span>
                                                <?php echo e(Form::checkbox('twilio_bill_notification', '1', isset($settings['twilio_bill_notification']) && $settings['twilio_bill_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'bill_notification'])); ?>
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                <?php echo e(Form::checkbox('twilio_proposal_notification', '1', isset($settings['twilio_proposal_notification']) && $settings['twilio_proposal_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'proposal_notification'])); ?>
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                <?php echo e(Form::checkbox('twilio_payment_notification', '1', isset($settings['twilio_payment_notification']) && $settings['twilio_payment_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'payment_notification'])); ?>
                                        ...
                                        <li class="list-group-item">
                                            <div class=" form-switch form-switch-right">
                                                ...
                                                <?php echo e(Form::checkbox('twilio_reminder_notification', '1', isset($settings['twilio_reminder_notification']) && $settings['twilio_reminder_notification'] == '1' ? 'checked' : '', ['class' => 'form-check-input', 'id' => 'reminder_notification'])); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div id="ip-restriction-settings" class="card">
                     ...
                     <div class="card" id="biometric-attendance">
                        <div class="col-md-12">
                            <?php echo e(Form::open(['route' => ['biometric-settings.store'], 'method' => 'post'])); ?>
                                ...
                                <div class="row">
                                    <div class="col-lg-8 col-md-8 col-sm-8">
                                        ...
                                        <small class="text-muted">
                                            <b class="text-danger"><?php echo e(__('Note')); ?>: </b>
                                            <?php echo e(__('Note that you can use the biometric attendance system only if you are using the ZKTeco machine for biometric attendance.')); ?>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <?php echo e(Form::label('zkteco_api_url', __('ZKTeco Api URL'), ['class' => 'col-form-label'])); ?>

                                        <?php echo e(Form::text('zkteco_api_url', !empty($settings['zkteco_api_url']) ? $settings['zkteco_api_url'] : '', ['class' => 'form-control ', 'placeholder' => 'ZKTeco Api URL', 'required' => 'required'])); ?>

                                        <small>
                                            <b class="text-dark"><?php echo e(__('Example:')); ?></b> http://110.78.645.123:8080
                                        </small>
                                    </div>
                                    <div class="col-md-3 form-group">
                                        <?php echo e(Form::label('username', __('Username'), ['class' => 'col-form-label'])); ?>

                                        <?php echo e(Form::text('username', !empty($settings['username']) ? $settings['username'] : '', ['class' => 'form-control ', 'placeholder' => 'Username', 'required' => 'required'])); ?>

                                    </div>
                                    <div class="col-md-3 form-group">
                                        <?php echo e(Form::label('user_password', __('Password'), ['class' => 'col-form-label'])); ?>

                                        <?php echo e(Form::text('user_password', !empty($settings['user_password']) ? $settings['user_password'] : '', ['class' => 'form-control ', 'placeholder' => 'Password', 'required' => 'required'])); ?>

                                    </div>
                                    <div class="col-md-8 form-group">
                                        <?php echo e(Form::label('auth_token', __('Auth Token'), ['class' => 'form-label'])); ?>

                                        <?php if(empty($settings['auth_token'])): ?>
                                            <small class="text-danger">
                                                <?php echo e(__('Please first generate auth token.')); ?>

                                            </small>
                                        <?php endif; ?>
                                        <?php echo e(Form::textarea('', !empty($settings['auth_token']) ? $settings['auth_token'] : null, ['class' => 'form-control font-style', 'disabled' => 'disabled', 'rows' => 3])); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Portfolio\Azure-VM\erpnbs\resources\views/settings/company.blade.php ENDPATH**/ ?>