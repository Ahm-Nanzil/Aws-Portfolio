...
<div class="float-end">
    <a href="#" class="btn btn-sm btn-primary" data-ajax-popup="true"
               data-title="<?php echo e(__('Create New Email Template')); ?>" title="<?php echo e(__('Create')); ?>" data-url="<?php echo e(route('email_template.create')); ?>">
                                ...
                                <div class="card-body">
                                    <div class="row text-xs">
                                        ...
                                        <?php elseif($emailTemplate->slug=='warning_sent'): ?>
                                            ...
                                            <div class="row">
                                                <p class="col-4"><?php echo e(__('Task Creator')); ?> : <span class="pull-end text-primary">{task_creator}</span></p>
                                                ...
                                                <p class="col-4"><?php echo e(__('Task Status')); ?> : <span class="pull-right text-primary">{task_status}</span></p>
                                                <p class="col-4"><?php echo e(__('From')); ?> : <span class="pull-right text-primary">{from}</span></p>
                                                <p class="col-4"><?php echo e(__('From Name')); ?> : <span class="pull-right text-primary">{from_name}</span></p>
                                                <p class="col-4"><?php echo e(__('Pipeline')); ?> : <span class="pull-right text-primary">{pipeline}</span></p>
                                                <p class="col-4"><?php echo e(__('Stage')); ?> : <span class="pull-right text-primary">{stage}</span></p>
                                                <p class="col-4"><?php echo e(__('Task Link')); ?> : <span class="pull-right text-primary"><a href="{task_link}">{task_link}</a></span></p>
                                                <p class="col-4"><?php echo e(__('Company Name')); ?> : <span class="pull-right text-primary">{company_name}</span></p>
                                            </div>
                                            <?php elseif($emailTemplate->slug == 'new_visit'): ?>
                                                <div class="row">
                                                    <p class="col-4"><?php echo e(__('Visit Creator')); ?> : <span class="pull-right text-primary">{visit_creator}</span></p>
                                                    <p class="col-4"><?php echo e(__('Visit Name')); ?> : <span class="pull-right text-primary">{visit_name}</span></p>
                                                    <p class="col-4"><?php echo e(__('From')); ?> : <span class="pull-right text-primary">{from}</span></p>
                                                    <p class="col-4"><?php echo e(__('From Name')); ?> : <span class="pull-right text-primary">{from_name}</span></p>
                                                    <p class="col-4"><?php echo e(__('Pipeline')); ?> : <span class="pull-right text-primary">{pipeline}</span></p>
                                                    <p class="col-4"><?php echo e(__('Stage')); ?> : <span class="pull-right text-primary">{stage}</span></p>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Portfolio\Azure-VM\erpnbs\resources\views/email_templates/show.blade.php ENDPATH**/ ?>