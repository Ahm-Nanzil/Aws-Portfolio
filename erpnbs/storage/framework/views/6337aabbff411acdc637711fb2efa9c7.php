<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="<?php echo e(route('customer_stages.index')); ?>" class="list-group-item list-group-item-action border-0 <?php echo e((Request::route()->getName() == 'customer_stages.index' ) ? ' active' : ''); ?>"><?php echo e(__('Customer Stages')); ?><div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
...
<?php /**PATH C:\xampp\htdocs\Portfolio\Azure-VM\erpnbs\resources\views/layouts/crm_setup.blade.php ENDPATH**/ ?>