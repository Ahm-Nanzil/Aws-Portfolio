            ...
            <?php if(\Auth::user()->type != 'client'): ?>
                <ul class="dash-navbar">
                    ...
                    <!--------------------- Start Account ----------------------------------->
                        ...
                        <!--------------------- Start Manange Activity ----------------------------------->

                        <?php if($show_dashboard == 1): ?>
                            <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'pipelines' || Request::segment(1) == 'deals' || Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' || Request::segment(1) == 'contract') ?' active dash-trigger':''); ?>">
                                <a href="#!" class="dash-link"
                                ><span class="dash-micon"><i class="ti ti-layers-difference"></i></span
                                    ><span class="dash-mtext"><?php echo e(__('Manage Activities')); ?></span
                                    ><span class="dash-arrow"><i data-feather="chevron-right"></i></span
                                    ></a>
                                <ul class="dash-submenu <?php echo e((Request::segment(1) == 'stages' || Request::segment(1) == 'labels' || Request::segment(1) == 'sources' || Request::segment(1) == 'lead_stages' || Request::segment(1) == 'leads'  || Request::segment(1) == 'form_builder' || Request::segment(1) == 'form_response' || Request::segment(1) == 'deals' || Request::segment(1) == 'pipelines')?'show':''); ?>">
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'all')?'active':''); ?>">
                                        <a class="dash-link" href="<?php echo e(route('activities.show.all')); ?>"><?php echo e(__('all ')); ?></a>
                                    </li>
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'activities')?'active':''); ?>">
                                        <a class="dash-link" href="<?php echo e(route('activities.index')); ?>"><?php echo e(__('Activities ')); ?></a>
                                    </li>
                                </ul>
                        <?php endif; ?>
                    ...
                    <?php endif; ?>
                        ...
                        <li class="dash-item dash-hasmenu">
                            ...
                            <a href="#!" class="dash-link ">
                                <span class="dash-micon"><i class="ti ti-shopping-cart"></i></span><span class="dash-mtext"><?php echo e(__('Purchase')); ?></span><span class="dash-arrow">
                                        <i data-feather="chevron-right"></i></span>
                            </a>
                            ...
                            <ul class="dash-submenu">
                                <?php if(Gate::check('manage product & service')): ?>
                                    <li class="dash-item <?php echo e((Request::segment(1) == 'productservice')?'active':''); ?>">
                                        <a href="<?php echo e(route('productservice.index')); ?>" class="dash-link"><?php echo e(__('Products')); ?>

                                        </a>
                                    </li>
                                <?php endif; ?>
                                <li class="dash-item <?php echo e((Request::segment(1) == 'vender')?'active':''); ?>">
                                    <a href="<?php echo e(route('vender.index')); ?>" class="dash-link"><?php echo e(__('Vendor')); ?>

                                    </a>
                                </li>
                                <li class="dash-item <?php echo e((Request::segment(1) == 'purchases' && Request::segment(2) == 'vendor_items') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('vendor_items.index')); ?>" class="dash-link"><?php echo e(__('Vendor Products')); ?></a>
                                </li>
                                <li class="dash-item <?php echo e((Request::segment(1) == 'purchases' && Request::segment(2) == 'purchase_request') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('purchase_request.index')); ?>" class="dash-link"><?php echo e(__('Purchase Request')); ?></a>
                                </li>
                                <li class="dash-item <?php echo e((Request::segment(1) == 'purchases' && Request::segment(2) == 'quotations') ? 'active' : ''); ?>">
                                    <a href="<?php echo e(route('quotations.index')); ?>" class="dash-link"><?php echo e(__('Quotations')); ?></a>
                                </li>
                        ...
                        <li class="dash-item dash-hasmenu <?php echo e((Request::segment(1) == 'users' || Request::segment(1) == 'roles'
                            ...
                            ><span class="dash-micon"><i class="ti ti-users"></i></span
                                ><span class="dash-mtext"><?php echo e(__('Access Management')); ?></span
                                ><span class="dash-arrow"><i data-feather="chevron-right"></i></span
                                ></a>
                            <ul class="dash-submenu">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage role')): ?>
                                    <li class="dash-item <?php echo e((Request::route()->getName() == 'roles.index' || Request::route()->getName() == 'roles.create' || Request::route()->getName() == 'roles.edit') ? ' active' : ''); ?> ">
                                        <a class="dash-link" href="<?php echo e(route('roles.index')); ?>"><?php echo e(__('Permission')); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php endif; ?>
                                <li class="dash-item <?php echo e((Request::route()->getName() == 'clients.index' || Request::segment(1) == 'clients' || Request::route()->getName() == 'clients.edit') ? ' active' : ''); ?>">
                                    <a class="dash-link" href="<?php echo e(route('hierarchy_structure')); ?>"><?php echo e(__('Structural Roles')); ?></a>
                                </li>
...
<?php /**PATH C:\xampp\htdocs\Portfolio\Azure-VM\erpnbs\resources\views/partials/admin/menu.blade.php ENDPATH**/ ?>