...
/**
 * lead-edit.php
 * Edit an existing lead. Validates and sanitizes all input before saving.
 */
...
$id = sanitizeText($_GET['id'] ?? $_POST['id'] ?? '');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        setFlash('success', 'Lead "' . $data['company_name'] . '" was updated successfully.');
        redirect('lead-view.php?id=' . urlencode($id));
    }
}

$pageTitle    = 'Edit Lead';
$pageSubtitle = $lead['company_name'];
...
<form method="post" novalidate>
    ...
    <div class="row g-3">
        ...
        <div class="col-12 d-flex justify-content-end gap-2">
            <a href="<?= e(BASE_URL) ?>/lead-view.php?id=<?= urlencode($id) ?>" class="btn btn-outline-secondary">Cancel</a>
