  ...
  var e = {
    checkImage: function (e) {
      return /(png|jpg|jpeg|gif|tiff|bmp|webp|avif)$/.test(
        e.getAttribute("href").toLowerCase().split("?")[0].split("#")[0]
      );
    },
    findImages: function () {
      var t = document.querySelectorAll(
        "a[href]:not(.kt-no-lightbox):not(.custom-link):not(.kb-gallery-item-link):not(.kt-core-gallery-lightbox)"
      );
      if (t.length && t)
        for (let l = 0; l < t.length; l++)
          e.checkImage(t[l]) &&
            (t[l].classList.add("kt-lightbox"),
            new SimpleLightbox({ elements: [t[l]] }));
    },
        ...
        for (let i = 0; i < t.length; i++) {
          ...
          if (l)
            for (let t = 0; t < l.length; t++)
              e.checkImage(l[t]) &&
                l[t].classList.add("kt-core-gallery-lightbox");
          t[i] &&
            new SimpleLightbox({
    ...
    init: function () {
      if ("function" == typeof SimpleLightbox) e.initAll();
        ...
        var t = setInterval(function () {
          "function" == typeof SimpleLightbox &&
            (e.initAll(), clearInterval(t));
        }, 200);
    },
  };
