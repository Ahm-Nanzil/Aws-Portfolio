!(function () {
  ...
  (window.kadence = {
    ...
    toggleAttribute: function (e, t, n, o) {
      void 0 === n && (n = !0),
        void 0 === o && (o = !1),
        e.getAttribute(t) !== n ? e.setAttribute(t, n) : e.setAttribute(t, o);
    },
            ...
            i.setAttribute(
              ...
              n.querySelector("a").addEventListener("focus", function (e) {
                ...
                for (let o = 0; o < t.length; o++)
                  n !== t[o] && window.kadence.toggleSubMenu(t[o], !1);
              }),
              t[a].addEventListener("keydown", function (e) {
                ...
                if (9 === e.keyCode) {
                  n =
                    "ul.toggle-show > li > a, ul.toggle-show > li > .dropdown-nav-special-toggle";
                  t[a].parentNode.classList.contains(
    ...
    initEachNavToggleSubmenuInside: function (e) {
      ...
      if (t.length)
        for (let n = 0; n < t.length; n++)
          t[n].addEventListener("mouseenter", function (e) {
            if (t[n].querySelector("ul.sub-menu")) {
              var o = t[n].querySelector("ul.sub-menu");
              window.kadence.getOffset(o).left + o.offsetWidth <=
                window.innerWidth || o.classList.add("sub-menu-edge");
            }
          });
    },
    toggleSubMenu: function (e, t) {
      ...
      if (
        ...
        n.setAttribute("aria-expanded", (!i).toString()),
        i)
      ) {
        setTimeout(function () {
          e.classList.remove("menu-item--toggled-on"),
            o.classList.remove("toggle-show"),
            n.setAttribute(
              "aria-label",
              a
    ...
    toggleDrawer: function (e, t) {
      ...
      if (o) {
        ...
        if (
          (window.kadence.toggleAttribute(n, "aria-expanded", "true", "false"),
          o.classList.contains("show-drawer"))
        )
          n.dataset.toggleBodyClass &&
            document.body.classList.remove(n.dataset.toggleBodyClass),
            o.classList.remove("active"),
            o.classList.remove("pop-animated"),
          ...
          (o.classList.add("show-drawer"),
          n.dataset.toggleBodyClass &&
            (document.body.classList.toggle(n.dataset.toggleBodyClass),
            n.dataset.toggleBodyClass.includes("showing-popup-drawer-") &&
          ...
          o.classList.contains("popup-drawer"))
        ) {
          var r = o.querySelectorAll(
    ...
    initStickyHeader: function () {
      ...
      var s,
        ...
        u = function (s) {
          var l,
            c = window.kadence.getOffset(n).top;
          if (
            ...
            if ("true" === m) {
              ...
              if (x <= A) l.style.transform = "translateY(0px)";
                ...
                l.classList.add("item-hidden-above"),
                  (l.style.transform =
                    "translateY(" + (Math.abs(M) > E ? -E : M) + "px)");
              else {
                A = Math.floor(d - c);
    ...
    getTopOffset: function (e = "scroll") {
      ...
      if (kadenceConfig.breakPoints.desktop <= window.innerWidth) {
        ...
        if (n)
          o =
            "true" === n.getAttribute("data-shrink")
              ? Math.floor(n.getAttribute("data-shrink-height"))
              : Math.floor(n.offsetHeight);
        else o = 0;
    ...
    anchorScrollToCheck: function (e, t) {
      ...
      if (
        !n.parentNode ||
        !n.parentNode.hasAttribute("role") ||
        "tab" !== n.parentNode.getAttribute("role")
      ) {
        var o;
        o = t
          ? t
          ...
          : n
              .getAttribute("href")
              .substring(n.getAttribute("href").indexOf("#"));
    ...
    initActiveAnchors: function () {
      "" != window.location.hash && window.kadence.updateActiveAnchors(),
      ...
      if (e) {
        ...
        window.addEventListener("scroll", t),
          ...
          e.addEventListener("click", function (e) {
            e.preventDefault(),
              window.scrollTo({ top: 0, behavior: "smooth" }),
              document.querySelector(".skip-link").focus({ preventScroll: !0 }),
              document.activeElement.blur();
          });
      }
