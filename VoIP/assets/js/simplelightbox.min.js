  ...
  return (
    ...
    t(o.prototype, {
      init: function (e) {
        ...
        var i,
          n = this;
        e.$items && (i = e.$items.get()),
          e.elements &&
            (i = [].slice.call(
              "string" == typeof e.elements
                ? document.querySelectorAll(e.elements)
                : e.elements
            )),
          ...
          i &&
            i.forEach(function (t, i) {
              n.items.push(t.getAttribute(e.urlAttribute));
              var s = t.getAttribute(e.captionAttribute);
              s ||
                ((s = t.querySelector("img")?.getAttribute(e.captionAttribute)),
                s ||
                  (s =
                    t.parentElement?.querySelector("figcaption")?.textContent)),
                n.captions.push(s),
                e.bindToItems &&
                  n.addEvent(
                    t,
      ...
      addEvent: function (t, e, i, n) {
        return (
          this.eventRegistry[n || "lightbox"].push({
            element: t,
            eventName: e,
            callback: i,
          }),
      ...
      loading: function (t) {
        ...
        t
          ...
          : (i(this.$el, s.elementLoadingClass),
      ...
      prepareItem: function (t, e) {
        ...
        if ((this.loading(!0), this.options.videoRegex.test(s))) {
          ...
          (this.$currentImage = r.querySelector(".slbImage")),
            this.options.showCaptions &&
              this.captions[t] &&
              r.appendChild(
                n('<div class="slbCaption">' + this.captions[t] + "</div>")
              ),
            this.loadImage(s, function () {
              i.setImageDimensions(),
                e.call(i, r),
                i.loadImage(
                  i.items[i.normalizePosition(i.currentPosition + 1)]
                );
            });
        }
        return this;
      ...
      setContent: function (t) {
        ...
        return (
          this.loading(!1),
          this.setupLightboxHtml(),
          i(this.$content, "slbDirectionNext"),
          i(this.$content, "slbDirectionPrev"),
          this.direction &&
            e(
              this.$content,
              "next" === this.direction
          ...
          this.options.beforeSetContent &&
            this.options.beforeSetContent(s, this),
        ...
        return (
          this.eventRegistry.lightbox.length ||
            this.addEvent(this.$el, "click", function (e) {
              var i = e.target;
              s(i, ".slbCloseBtn") ||
              (t.options.closeOnOverlayClick && s(i, ".slbWrap"))
                ? t.close()
                : s(i, ".slbArrow")
                ? s(i, ".next")
                  ? t.next()
                  : t.prev()
                : t.options.nextOnImageClick &&
                  t.items.length > 1 &&
                  s(i, ".slbImage") &&
                  t.next();
            })
              .addEvent(document, "keyup", function (e) {
                t.options.closeOnEscapeKey && 27 === e.keyCode && t.close(),
                  t.items.length > 1 &&
                    ((39 === e.keyCode || 68 === e.keyCode) && t.next(),
    ...
    (o.registerAsJqueryPlugin = function ($) {
      ($.fn.simpleLightbox = function (t) {
        var e,
          i = this;
        return this.each(function () {
          $.data(this, "simpleLightbox") ||
            ((e = e || new o($.extend({}, t, { $items: i }))),
            $.data(this, "simpleLightbox", e));
        });
      }),
        ($.SimpleLightbox = o);
    }),
    "undefined" != typeof window &&
      window.jQuery &&
      o.registerAsJqueryPlugin(window.jQuery),
    o
  );
});
