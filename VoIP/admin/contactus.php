                    ...
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <p class="title mb-0">Contact Us Section</p>
                            <p class="text-muted">Edit the contact us section details</p>
                          </td>
                          <td class="td-actions text-right">
                            <button type="button" class="btn btn-link" data-toggle="modal" data-target="#contactUsModal" title="Edit Section">
