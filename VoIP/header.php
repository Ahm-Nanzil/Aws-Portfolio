...
<html>
  ...
  #mobile-header {
    ...
    background: #fff; /* required to avoid transparency */
  }

  /* Prevent inner containers from limiting width */
  #mobile-header .site-container {
    max-width: 100%;
    padding-left: 16px;   /* optional */
  ...
  body {
    ...
    <link
      ...
      href="<?= setting('favicon') 
        ...
        : 'assets/img/default/favicon.png'; ?>"
      sizes="32x32"
    />
    <link
      rel="icon"
